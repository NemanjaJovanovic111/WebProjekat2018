...
function fillTable(emergencies) {
	...
	$.each(emergencies, function (index, emergency) {
	    ...
	    $('#emergencies').append(
	    	$('<tr>').append(
	    		$('<td>').append(
	    			$('<input type="button" value="View" onclick="viewEmergency(\'' + emergency.locationName + '\',\'' +
	    					emergency.municipalitie + '\',\'' + emergency.description + '\',\'' + emergency.dateTime + '\',\'' +
emergency.gMapLoc + '\',\'' + emergency.territory + '\',\'' + emergency.emergencyType + '\',\'' + emergency.picture + '\',\'' +
emergency.emergencyState + '\',\'' + emergency.volunteer + '\')"/>')
	    		),
	    		$('<td>', {
...
function viewEmergency(locationName, municipalitie, description, dateTime, gMapLoc,
